                        ...
                        <ul class="navbar-nav me-auto">
                            <li class="nav-item">
                                ...
                                <a class="nav-link btn btn-no-border-orange" data-bs-toggle="collapse" href="#addItemForm" role="button" aria-expanded="false" aria-controls="addItemForm">
                                    New Item <i class="bi bi-plus-circle"></i>
                                </a>
                            </li>
                            <li class="nav-item">
                                <!--Navigation button to show the form to add item button-->
                        ...
                        <div class="card-body">
							...
							Size
								<div class="mb-1 form-check form-check-inline">
									<input type="radio" class="btn-check" value="U" name="itemsize" id="itemsize_U"/>
									<label for="itemsize_U" class="btn btn-outline-dark">Uragon</label>
								</div>
								<div class="mb-1 form-check form-check-inline">							
									<input type="radio" class="btn-check" value="M" name="itemsize" id="itemsize_M" />
									<label for="itemsize_M" class="btn btn-outline-dark">Magayon</label>
								</div>
                            <div class="mb-1">
            ...
            <div class="col-lg-3">
                <div id="addCategory" class="card collapse mt-5 shadow">
                    ...
                    <form action="addCategory.php" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="mb-1">
                                <label for="c_Catname" class="form-label">Category Name</label>
                                <input name="catname" id="c_Catname " type="text" class="form-control">
                            </div>
                            <div class="mb-1">
                                <label for="catimage" class="form-label">Image</label>
                                <input name="catimage" id="catimage" type="file" class="form-control">
                            </div>
                            <div class="mb-1">
...
if(!isset($searchkey)){
    if(!empty($category_list) || $category_list !== false){
        ...
        <div class="row p-3 rounded-2 border border-bottom-0 border-info">
